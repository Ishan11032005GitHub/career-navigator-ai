...
# def db_execute(query, params=(), fetchone=False, commit=False):
#     conn = get_db()
#     cur = conn.cursor()
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["Content-Disposition"],  # ✅ allows browser to download PDFs
)

# ==========================================================
# STATIC FILES (Outside OneDrive for speed)
# ==========================================================
DATA_ROOT = "C:\\career_ai_data"
